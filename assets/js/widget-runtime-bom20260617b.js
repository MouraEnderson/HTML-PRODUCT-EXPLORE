/* PR #21 — BOM Widget runtime ES5 (3DDashboard / Rhino compatible) */
(function (w) {
  'use strict';
  ...
  var RELEASE_COMMIT = w.__BOM_RELEASE_COMMIT__ || '9c1893f';
  ...
  w.__BOM_RELEASE_MANIFEST__ = {
    ...
    runtime: 'widget-runtime-bom20260617b.js',
    bundle: 'bom-bundle-' + BASE_BUILD + '.js',
    provider: 'product-explorer-sync-provider.js',
    hotfix: 'bom-ska-service-hotfix-20260617b.js',
    ...
    loadScript(GH + 'assets/vendor/chart.umd.min.js' + q, true, function () {
      loadScript(GH + 'assets/js/bom-bundle-' + BASE_BUILD + '.js' + q, false, function (err) {
        ...
        loadScript(GH + 'assets/js/integration/product-explorer-sync-provider.js' + q, false, function (errSync) {
          ...
          loadScript(GH + 'assets/js/bom-ska-service-hotfix-20260617b.js' + q, false, function (err3) {
            if (err3) {
